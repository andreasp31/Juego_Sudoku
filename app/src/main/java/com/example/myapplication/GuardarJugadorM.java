...
public class GuardarJugadorM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guardar_jugador_m);
   ...
   public void irSudoku(View view){
        Intent intent = new Intent(this,SudokuMedio.class);
