...
public class AdaptadorSudoku extends BaseAdapter {
    ...
    public  AdaptadorSudoku (Context context, int[][] tablero, int[][]tableroOriginal,boolean[][] celdasIncorrectas){
        ...
        if(valorCelda !=0){
            ...
            if (tableroOriginal[fila][columna] != 0) {
                ...
                if(celdasIncorrectas != null && celdasIncorrectas[fila][columna]){
                    vistaCelda.setTextColor(Color.RED);
                }
                else{
